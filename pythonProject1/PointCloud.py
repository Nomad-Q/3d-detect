...
if __name__ == "__main__":
    ...
    # pcl1 = Cloud(file='models/my_test_cloud_1.ply')
    ...
    # pcl.visualize()
    """ PLY files creation """
    if os.path.exists('models/my_test_cloud_1.ply'):
        os.remove('models/my_test_cloud_1.ply')
    # file = open('models/my_test_cloud_1.ply', 'w').close()
    pcl = Cloud(file='models/my_test_cloud_1.ply', depth=True)
    pcl = Cloud(file='models/my_test_cloud_1.ply', color=True)
    """ PCD files creation """
